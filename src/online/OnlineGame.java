...
public class OnlineGame extends JPanel implements KeyListener, Runnable {
    private final Thread thread;
    private final boolean isRunning = true;
    private final BitSet bitSet = new BitSet(256);
    private final ManagerItem2 managerItem2;
...
//            }
            ...
            if (managerItem2.killTank()) {
                bitSet.clear();
//                int check = JOptionPane.showConfirmDialog(OnlineGame.this, "Do you want continue", "Player 2 Win", JOptionPane.YES_NO_OPTION);
...
//                bitSet.clear();
//                int check = JOptionPane.showConfirmDialog(OnlineGame.this, "Do you want continue", "Player 1 Win", JOptionPane.YES_NO_OPTION);
//                if (check == JOptionPane.YES_OPTION) {
//                    managerItem2 = new ManagerItem2();
//                    managerItem2.readMap("map2player.txt");
//                } else System.exit(0);
